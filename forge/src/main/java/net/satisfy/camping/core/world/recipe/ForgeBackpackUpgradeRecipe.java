...
import net.satisfy.camping.core.registry.ForgeCampingRecipes;
...
public class ForgeBackpackUpgradeRecipe extends ShapedRecipe implements IWrapperRecipe<ShapedRecipe> {
    ...
    public RecipeSerializer<?> getSerializer() {
        return ForgeCampingRecipes.BACKPACK_UPGRADE;
    }
