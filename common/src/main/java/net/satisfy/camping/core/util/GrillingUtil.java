...
public class GrillingUtil {
    ...
    public static GrillingUtil.FoodValue getAdditionalFoodValue(ItemStack itemStack) {
        ...
        if (tag != null && tag.contains(NUTRITION_KEY) && tag.contains(SATURATION_KEY)) {
            ...
            return new GrillingUtil.FoodValue(nutrition, saturation);
        }
        return new GrillingUtil.FoodValue(0, 0.0F);
    }
