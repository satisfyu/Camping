...
public final class EntityTypeRegistry {
    ...
    public static final RegistrySupplier<BlockEntityType<EnderPackBlockEntity>> ENDERPACK_BLOCK_ENTITY = registerBlockEntity("enderpack", () -> BlockEntityType.Builder.of(EnderPackBlockEntity::new, ENDERPACK.get()).build(null));
