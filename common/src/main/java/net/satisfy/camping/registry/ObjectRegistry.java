...
public class ObjectRegistry {
    ...
    public static final RegistrySupplier<Block> ENDERPACK = registerWithoutItem("enderpack", () -> new BackpackBlock(BlockBehaviour.Properties.of().mapColor(MapColor.WOOD).instrument(NoteBlockInstrument.BIT).strength(1.5F).sound(SoundType.CANDLE).ignitedByLava().noOcclusion().noParticlesOnBreak().instabreak(), BackpackBlock.BackpackType.ENDERPACK));
    public static final RegistrySupplier<Item> ENDERPACK_ITEM = registerItem("enderpack", () -> new BackpackItem(ENDERPACK.get(), new Item.Properties(), ArmorMaterials.LEATHER, ArmorItem.Type.CHESTPLATE, new CampingIdentifier("textures/model/enderpack.png")));
