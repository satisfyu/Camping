...
public class ObjectRegistry {
    ...
    public static final RegistrySupplier<Block> SMALL_BACKPACK = registerWithoutItem("small_backpack", () -> new BackpackBlock(BlockBehaviour.Properties.of().mapColor(MapColor.WOOD).instrument(NoteBlockInstrument.BIT).strength(1.5F).sound(SoundType.CANDLE).ignitedByLava().noOcclusion().noParticlesOnBreak().instabreak(), BackpackBlock.BackpackType.SMALL_BACKPACK));
    public static final RegistrySupplier<Item> SMALL_BACKPACK_ITEM = registerItem("small_backpack", () -> new BackpackItem(SMALL_BACKPACK.get(), new Item.Properties(), ArmorMaterials.LEATHER, ArmorItem.Type.CHESTPLATE, new CampingIdentifier("textures/model/small_backpack.png")));
    public static final RegistrySupplier<Block> LARGE_BACKPACK = registerWithoutItem("large_backpack", () -> new BackpackBlock(BlockBehaviour.Properties.of().mapColor(MapColor.WOOD).instrument(NoteBlockInstrument.BIT).strength(1.5F).sound(SoundType.CANDLE).ignitedByLava().noOcclusion().noParticlesOnBreak().instabreak(), BackpackBlock.BackpackType.LARGE_BACKPACK));
    ...
    public static final RegistrySupplier<Block> WANDERER_BAG = registerWithoutItem("wanderer_bag", () -> new BackpackBlock(BlockBehaviour.Properties.of().mapColor(MapColor.WOOD).instrument(NoteBlockInstrument.BIT).strength(1.5F).sound(SoundType.CANDLE).ignitedByLava().noOcclusion().noParticlesOnBreak().instabreak(), BackpackBlock.BackpackType.WANDERER_BAG));
    public static final RegistrySupplier<Item> WANDERER_BAG_ITEM = registerItem("wanderer_bag", () -> new BackpackItem(WANDERER_BAG.get(), new Item.Properties(), ArmorMaterials.LEATHER, ArmorItem.Type.CHESTPLATE, new CampingIdentifier("textures/model/wanderer_bag.png")));
    public static final RegistrySupplier<Block> GOODYBAG = registerWithoutItem("goodybag", () -> new BackpackBlock(BlockBehaviour.Properties.of().mapColor(MapColor.WOOD).instrument(NoteBlockInstrument.BIT).strength(1.5F).sound(SoundType.CANDLE).ignitedByLava().noOcclusion().noParticlesOnBreak().instabreak(), BackpackBlock.BackpackType.GOODYBAG));
    public static final RegistrySupplier<Item> GOODYBAG_ITEM = registerItem("goodybag", () -> new BackpackItem(GOODYBAG.get(), new Item.Properties(), ArmorMaterials.LEATHER, ArmorItem.Type.CHESTPLATE, new CampingIdentifier("textures/model/goodybag.png")));
    public static final RegistrySupplier<Block> SHEEPBAG = registerWithoutItem("sheepbag", () -> new BackpackBlock(BlockBehaviour.Properties.of().mapColor(MapColor.WOOD).instrument(NoteBlockInstrument.BIT).strength(1.5F).sound(SoundType.CANDLE).ignitedByLava().noOcclusion().noParticlesOnBreak().instabreak(), BackpackBlock.BackpackType.SHEEPBAG));
    public static final RegistrySupplier<Item> SHEEPBAG_ITEM = registerItem("sheepbag", () -> new BackpackItem(SHEEPBAG.get(), new Item.Properties(), ArmorMaterials.LEATHER, ArmorItem.Type.CHESTPLATE, new CampingIdentifier("textures/model/sheepbag.png")));
