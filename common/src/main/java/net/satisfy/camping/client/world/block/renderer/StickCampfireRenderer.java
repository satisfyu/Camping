...
public class StickCampfireRenderer implements BlockEntityRenderer<StickCampfireBlockEntity> {
    private static final float SIZE = 0.375F;
    private final ItemRenderer itemRenderer;

    public StickCampfireRenderer(BlockEntityRendererProvider.Context $$0) {
        super();
        this.itemRenderer = $$0.getItemRenderer();
    }

    private static final float yOffset = 0.0625f * -2f;

    public void render(StickCampfireBlockEntity $$0, float $$1, PoseStack stack, MultiBufferSource $$3, int $$4, int $$5) {
        Direction $$6 = (Direction)$$0.getBlockState().getValue(StickCampfireBlock.FACING);
