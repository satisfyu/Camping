package net.satisfy.camping.neoforge.integration;
...
import net.satisfy.camping.neoforge.client.CampingClientNeoForge;
        ...
        switch (type) {
            case ENDERPACK -> {
                this.model = new EnderpackModel<>(
                        Minecraft.getInstance().getEntityModels().bakeLayer(CampingClientNeoForge.ENDERPACK_LAYER)
                );
                this.texture = ResourceLocation.fromNamespaceAndPath("camping", "textures/model/enderpack.png");
            }
            case ENDERBAG -> {
                this.model = new EnderbagModel<>(
                        Minecraft.getInstance().getEntityModels().bakeLayer(CampingClientNeoForge.ENDERBAG_LAYER)
                );
                this.texture = ResourceLocation.fromNamespaceAndPath("camping", "textures/model/enderbag.png");
            }
            case GOODYBAG -> {
                this.model = new GoodybagModel<>(
                        Minecraft.getInstance().getEntityModels().bakeLayer(CampingClientNeoForge.GOODYBAG_LAYER)
                );
                this.texture = ResourceLocation.fromNamespaceAndPath("camping", "textures/model/goodybag.png");
            }
            case LARGE_BACKPACK -> {
                this.model = new LargeBackpackModel<>(
                        Minecraft.getInstance().getEntityModels().bakeLayer(CampingClientNeoForge.LARGE_BACKPACK_LAYER)
                );
                this.texture = ResourceLocation.fromNamespaceAndPath("camping", "textures/model/large_backpack.png");
            }
            case SHEEPBAG -> {
                this.model = new SheepbagModel<>(
                        Minecraft.getInstance().getEntityModels().bakeLayer(CampingClientNeoForge.SHEEPBAG_LAYER)
                );
                this.texture = ResourceLocation.fromNamespaceAndPath("camping", "textures/model/sheepbag.png");
            }
            case WANDERER_BACKPACK -> {
                this.model = new WandererBackpackModel<>(
                        Minecraft.getInstance().getEntityModels().bakeLayer(CampingClientNeoForge.WANDERER_BACKPACK_LAYER)
                );
                this.texture = ResourceLocation.fromNamespaceAndPath("camping", "textures/model/wanderer_pack.png");
            }
            case WANDERER_BAG -> {
                this.model = new WandererBagModel<>(
                        Minecraft.getInstance().getEntityModels().bakeLayer(CampingClientNeoForge.WANDERER_BAG_LAYER)
                );
                this.texture = ResourceLocation.fromNamespaceAndPath("camping", "textures/model/wanderer_bag.png");
            }
            default -> {
                this.model = new SmallBackpackModel<>(
                        Minecraft.getInstance().getEntityModels().bakeLayer(CampingClientNeoForge.SMALL_BACKPACK_LAYER)
                );
                this.texture = ResourceLocation.fromNamespaceAndPath("camping", "textures/model/small_backpack.png");
            }
        }
    }
