...
import net.satisfy.camping.neoforge.core.registry.CampingRecipesNeoForge;
...
//        });
        ...
        CapabilityBackpackWrapper.BACKPACK_WRAPPER_CAPABILITY.getCapability(upgradedBackpack, (BackpackItem) upgradedBackpack.getItem())
                        .setSlotNumbers(((BackpackItem) upgradedBackpack.getItem()).getNumberOfSlots(), ((BackpackItem) upgradedBackpack.getItem()).getNumberOfUpgradeSlots());
    ...
    public RecipeSerializer<?> getSerializer() {
        return CampingRecipesNeoForge.BACKPACK_UPGRADE.get();
    }
